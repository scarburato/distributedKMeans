...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\Procedure{MergeAverage}{$B_a$, $B_b$} \Comment{The same as Equation
			\ref{mergeAvg}}
	...
	\hfill
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot +[mark=none, color=red] coordinates {(2500000, 20) (2500000, 55)};
			\end{axis}
		\end{tikzpicture}
	...
	\begin{subfigure}[b]{0.425\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot +[mark=none, color=red] coordinates {(1500000, 20) (1500000, 55)};
			\end{axis}
		\end{tikzpicture}
